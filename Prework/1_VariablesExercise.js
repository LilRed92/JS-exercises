...
let dreamDestination = 'anywhere with mountains';
...
// num2 but not num1?
// The difference between the rules is that num1 must be GREATER THAN 1 or LESS THAN 10
// Meaning 1 and 10 are not valid values for num1. However, because num2 can be EQUAL TO
// OR LESS or GREATER 1 or 10 could be valid values for num2.
...
// These excercises were easy. For exercises 13-22 I simply tested out the value 
// outputs myself by using console.log.
