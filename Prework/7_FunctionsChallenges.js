...
function removeFromString(str, index, numToRemove) {
  const before = str.slice(0, index);
  const after = str.slice(index + numToRemove);
  return before + after;
}
...
console.log(indexOf([5, 10, 15, 20], 20));
console.log(indexOf([1, 2, 3, 4, 5], 15));
